...
// --- Enhanced Mock Data with Download Links ---
const detailedReportsData = [
  {
    ...
    date: 'May 1, 2025',
    downloadLink: 'https://acrobat.adobe.com/id/urn:aaid:sc:VA6C2:1be30a13-65dd-4606-9fff-9538b8cc0892',
    content: {
  ...
  },
  {
    ...
    date: 'April 15, 2025',
    downloadLink: 'https://acrobat.adobe.com/id/urn:aaid:sc:VA6C2:a219cfd7-b2fb-4944-ab44-9ad82aca4293',
    content: {
  ...
  },
  {
    ...
    date: 'April 10, 2025',
    downloadLink: 'https://acrobat.adobe.com/id/urn:aaid:sc:VA6C2:ad1b3756-5637-4576-8f33-bf955a8abeda',
    content: {
  ...
  return (
    <div className="mt-6 bg-white rounded-lg shadow-lg border p-6 space-y-4 animate-fade-in">
      ...
      <div className="space-y-2">
        ...
        <button onClick={() => handleProcessText(report.content.diagnosis, 'diagnosis')} disabled={isProcessing}
          className="flex items-center gap-2 text-sm text-teal-600 font-semibold hover:text-teal-800 disabled:opacity-50">
      ...
      <div className="space-y-2 pt-4 border-t">
        ...
        <button onClick={() => handleProcessText(report.content.recommendations, 'recommendations')} disabled={isProcessing}
          className="flex items-center gap-2 text-sm text-blue-600 font-semibold hover:text-blue-800 disabled:opacity-50">
          <BrainCircuit size={16} /> Explain This to Me
        </button>
            ...
            <div key={report.id} className="flex items-center justify-between py-4">
              ...
              {report.downloadLink && (
                <a 
                  ...
                  className="ml-4 flex-shrink-0 flex items-center gap-2 rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 transition-colors"
                >
